...
def plot_snake(gameWindow , color , snake_list ,snake_size):
    ...
    for x,y in snake_list:
        ...
        #  pygame.draw.circle(gameWindow, black[0][1], (x, y), 25)
        #  pygame.draw.circle(gameWindow, black, (100, 71), 11, 0)
#welcome screen 
def welcome():
    exit_game = False
    while not exit_game:
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            # plot_snake(gameWindow, black, (100, 71), 11, 0)
        pygame.display.update()
        clock.tick(fps)
